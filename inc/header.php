...
<head>
    ...
    <style>
      ...
      .cta-btn {float: none;margin: 0 auto;}
    </style>
      ...
      <nav class="navbar navbar-expand-lg navbar-light" data-sticky="top">
        <div class="container">
          ...
          <div class="d-flex align-items-center order-lg-3">
            <a href="https://themeforest.net/item/jumpstart-app-and-software-template/24207799" class="btn btn-primary ml-lg-4 mr-3 mr-md-4 mr-lg-0 d-none d-sm-block order-lg-3">أشتري الان</a> <a href="https://themeforest.net/item/jumpstart-app-and-software-template/24207799" class="btn  btn-outline-primary ml-lg-4 mr-3 mr-md-4 mr-lg-0 d-none d-sm-block order-lg-3">تسجيل الدخول</a>
          ...
          <div class="collapse navbar-collapse order-3 order-lg-2 justify-content-lg-end" id="navigation-menu">
            <ul class="navbar-nav my-3 my-lg-0">
              <li class="nav-item">
                  ...
                  <a aria-expanded="false" aria-haspopup="true" class="nav-link nav-item "  href="#" role="button">الرئيسية </a>
                
          
              </li>
              <li class="nav-item">
                        <a aria-expanded="false" aria-haspopup="true" class=" nav-link nav-item "  href="#" role="button">لماذا أبوة</a>
              </li>
              <li class="nav-item">
                  <a aria-expanded="false" aria-haspopup="true" class=" nav-link nav-item " href="#" role="button">طريقة الاستخدام</a>
              </li>
              <li class="nav-item">
                  <a aria-expanded="false" aria-haspopup="true" class="nav-link nav-item " href="#" role="button">تواصل معنا</a>
              </li>
            </ul>
          </div>
        </div>
