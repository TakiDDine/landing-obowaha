          ...
          <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-5 col-md-6 mb-5 mb-md-0">
              <div class="card card-body shadow">
                <h1 class="h5 text-center">انشاء حساب  </h1>
                <form>
                  <div class="form-group">
                    <input type="email" class="form-control" name="sign-up-email" placeholder="البريد الالكتروني">
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control" name="sign-up-password" placeholder="كلمة المرور">
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control" name="sign-up-password-confirm" placeholder="تاكيد كلمة المرور ">
                  </div>
                  <div class="form-group">
                    <div class="custom-control custom-checkbox text-small">
                      <input type="checkbox" class="custom-control-input" id="sign-up-agree">
                      <label class="custom-control-label" for="sign-up-agree">انا اقبل <a target="_blank" href="utility-legal-terms.html">الشروط</a>
                      </label>
                    </div>
                  </div>
                  <button class="btn btn-primary btn-block" type="submit">نشاء حساب  </button>
                </form>
              </div>
              <div class="text-center text-small mt-3">
                هل لديك حساب    ؟ <a href="account-sign-in-simple.html">تسجيل الدخول</a>
              </div>
            </div>
...
<!-- Mirrored from jumpstart.mediumra.re/account-sign-up-simple.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2020 23:55:21 GMT -->
</html>
