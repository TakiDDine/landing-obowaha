          ...
          <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-5 col-md-6">
              <div class="card card-body shadow">
                <h1 class="h5 text-center">استرجاع كلمة المرور</h1>
                <form>
                  <div class="form-group">
                    <input type="email" class="form-control" name="sign-up-email" placeholder="البريد الالكتروني">
                  </div>
                  <button class="btn btn-primary btn-block" type="submit">أرسال خطوات الاسترجاع</button>
                </form>
              </div>
              <div class="text-center text-small mt-3">
               تذكرت كلمة المرور؟ <a href="account-sign-in-simple.html">تسجيل الدخول</a>
              </div>
            </div>
          </div>
        </div>
...
<!-- Mirrored from jumpstart.mediumra.re/account-forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2020 23:55:22 GMT -->
</html>
